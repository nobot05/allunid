            ...
            <div className="signupFrm">
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <div className="inputContainer">
                        ...
                        <label htmlFor="" className="label">Your Full Name</label>
                    </div>
                    <div className="inputContainer">
                        {/* <input type="text" className="input" placeholder="a" value={user.email} onChange={handleChange}/> */}
                        <input type="email" className="input" placeholder="a" id="email" required/>
                        <label htmlFor="" className="label">Email</label>
                    </div>
                    <div className="inputContainer">
                        {/* <input type="text" className="input" placeholder="a" value={user.password} onChange={handleChange}/> */}
                        <input type="password" className="input" placeholder="a" id="password" required/>
                    ...
                    <div className="switching">
                        <button type="submit" className="submitBtn">{status}</button>
